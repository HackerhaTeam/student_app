...
import 'package:student_hackerha/features/home/presentation/widgets/advanced_theme_switcher.dart';
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(left: 25.w(context)),
                      child: AdvancedThemeSwitcher(),
                    ),
                    Spacer(),
                    Text(
                      "إغلاق",
