...
import 'package:student_hackerha/features/quiz/presentation/result_screen/widgets/progress/smooth_progress_indicator.dart';
    ...
    return Column(
      children: [
        CustomScaleAnimation(
            ...
            child: SmoothProgressInidicator(percentage: percentage)),
